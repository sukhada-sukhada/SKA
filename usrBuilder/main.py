import json, math, re
from constants.nameEntity import NE_LIST, AVYA_LIST
from constants.mappedRel import RELATION_MAP, CONCEPT_MAP, MAIN_MAP
from constants.tamList import TAM_LIST
from constants.discourseParticles import DISCOURSE_PARTICLES_DEP
from constants.number_wx import NUMBER_MAP
    ...
    for file_name, entries in data.items():
        ...
        for entry in entries:
            ...
            if dep_rel in DISCOURSE_PARTICLES_DEP or (
                dep_rel in ['समुच्चय_द्योतकः', 'सुप्_समुच्चय_द्योतकः'] and entry.get("root") == 'अपि'):
