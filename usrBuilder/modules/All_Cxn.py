...
#         # Insert if scheduled
#         if insert_next:
#             dep_label, next_dep_ref, new_float_index, next_cxn = insert_next
#             print(insert_next)
#             count = dep_label_counters.get(dep_label, 0) + 1
#             dep_label_counters[dep_label] = count
#             dep_label_indexed = f"{dep_label}_{count}"
#             inserted_line = f"[{dep_label_indexed}]\t{new_float_index}\t-\t-\t{next_dep_ref}\t-\t-\t-\t{next_cxn}\n"
...
#                 #     rel1 = 'op1'
#                 #     rel2 = 'op2'
#                 if 'बहुव्रीहिः' in clean_dep_label:
#                     rel1 = 'comp1'
#                     rel2 = 'comp2'
#                 else:
#                     rel1 = 'mod'
...
# # Example usage
# extract_and_check_duplicates('processed_output.txt', 'IO/cxn_output.txt')
    ...
    while i < len(lines):
        ...
        if insert_next:
            ...
            if len(updated_lines) >= 2:
                ...
                prev_to_prev_line = updated_lines[-2].split('\t')
                clean_dep_label = dep_label.strip()
                # Relation assignment based on label
                if 'बहुव्रीहिः' in clean_dep_label:
                    rel1 = 'comp1'
                    rel2 = 'comp2'
                else:
...
# Example usage
extract_and_check_duplicates('IO/cxn_output.txt', 'IO/final_cxn_output.txt')
