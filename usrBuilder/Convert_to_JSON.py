...
from constants.Drop_Columns import COLUMN_TO_DROP
...
def convert_tsv_folder_to_json(folder_path, json_file_path):
    try:
        ...
        filenames = [filename for filename in os.listdir(folder_path) if filename.endswith(".csv")]
        filenames.sort()
        ...
        for filename in filenames:
            ...
            data.drop(columns=COLUMN_TO_DROP, inplace=True, errors='ignore')
        ...
        print(f"Files have been successfully converted to JSON file at {json_file_path}")
    except Exception as e:
        print(f"An error occurred: {e}")

folder_path = sys.argv[1]
json_file_path = 'IO/combined_data.json'
